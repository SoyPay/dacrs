...
static const int nBlockRemainCoinDayHeight = 700000;  //此高度之后，用新的剩余币龄算法
class CCoinsDB;
class CBlockTreeDB;
...
public:
    ...
    CBlockIndex *FindFork(const ST_BlockLocator &locator) const;
};
...
protected:
    ...
    virtual void SetBestChain(const ST_BlockLocator &locator) =0;
