...
static void CreateRegisterTx() {
	...
	CommandLineRPC(nArgc, const_cast<char**>(argv));
}
...
bool CreateBetTx1() {
	...
	vstrInputParams.push_back("010000000100");
	vstrInputParams.push_back("[]");
	vstrInputParams.push_back(
			"[\"5j9hghjMKwAcY33kQoSxPDJPvokt75dDeYpU5LVgUc\",\"5zQPcC1YpFMtwxiH787pSXanUECoGsxUq3KZieJxVG\"]");
	vstrInputParams.push_back("0b434b430046003531303030303030300000000000000000000000");
