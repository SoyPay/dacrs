...
void CreateNormalTx() {
	...
	int argc = 7;
	char *argv[7] = { "rpctest", "createnormaltx", "5zQPcC1YpFMtwxiH787pSXanUECoGsxUq3KZieJxVG",
...
void CreateRegScriptTx() {
	...
	int argc = 6;
	char *argv[6] =
			{ "rpctest", "registerscripttx", "5Vp1xpLT8D2FQg3kaaCcjqxfdFNRhxm4oy7GXyBga9",
...
void CreateRegBetScriptTx() {
	...
	int argc = 6;
	char *argv[6] =
			{ "rpctest", "registerscripttx", "5SKNSaC9zRQ2YkL1oo8jGcgSAjNrbEZLJ3FqEkrUu2",
...
bool CreateSecuretx() {
	...
	int argc = 8;
//	char *argv[8] = {"rpctest", "createsecuretx", "030000000300", "[\"5Vp1xpLT8D2FQg3kaaCcjqxfdFNRhxm4oy7GXyBga9\"]", "[\"5j9hghjMKwAcY33kQoSxPDJPvokt75dDeYpU5LVgUc\",\"5zQPcC1YpFMtwxiH787pSXanUECoGsxUq3KZieJxVG\"]", "01021e00070021120500000000000000", "100000", "10"};
//	CommandLineRPC(argc, argv);
	std::vector<std::string> vInputParams;
	vInputParams.clear();
...
void GetAccountInfo(char *address) {
