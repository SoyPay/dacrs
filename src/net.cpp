...
void CNode::PushVersion()
{
    ...
    PushMessage("version", PROTOCOL_VERSION, g_ullLocalServices, nTime, addrYou, addrMe,
    		g_ullLocalHostNonce, FormatSubVersion(CLIENT_NAME, CLIENT_VERSION, comments), nBestHeight, true);
}
