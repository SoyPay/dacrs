/* src/dacrs-config.h.  Generated from dacrs-config.h.in by configure.  */
/* src/dacrs-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DACRS_CONFIG_H

#define DACRS_CONFIG_H
...
#define PACKAGE_BUGREPORT "info@Dacrs.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Dacrs Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Dacrs Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "Dacrs"
